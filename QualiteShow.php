...
<head>
        ...
        <!-- Welcome service area start -->
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="section-headline text-center">
                                        <h3>Qualité</h3>
                                        <p>La qualité prend en compte les pièces fabriquées qui ne répondent pas aux normes de qualité, y compris les pièces qui doivent être retravaillées. Rappelez-vous que la qualité est similaire au rendement au premier passage, en partant du principe qu'elle définit les bonnes pièces comme des pièces qui passent avec succès le processus de fabrication la première fois sans avoir besoin d'être retravaillées.

                                            La qualité est calculée comme ceci : <br>  </p>
                                    <br>  <p style="color: rgba(31, 209, 91, 0.692) ; font-weight: bold;">   Qualité = Nombre de bonnes pièces / Nombre de pièces total</p>
                                    
                                    <br>
                                    <p>Cela revient à prendre le rapport entre le temps pleinement productif (uniquement les bonnes pièces fabriquées aussi vite que possible sans temps d'arrêt) et le temps d'exécution net (toutes les pièces fabriquées aussi vite que possible sans temps d'arrêt). </p>
                    ...
                    <?php 
         $get_data = "SELECT * FROM `qualite` WHERE id=(SELECT MAX(id) FROM `qualite`)";

         $run_data = mysqli_query($con,$get_data);
     
         if($data = mysqli_fetch_array($run_data)){
     
             $Nb_bonne =  $data['Nb_bonne_piece'];
             $Nb_bonne_piece = sprintf('%.2f',$Nb_bonne);
                ...
                <div class="row">
				   <div class="fun-content">
						<div class="col-md-4 col-sm-4 col-xs-6">
							<div class="fun_text">
								<span class="counter"><?php echo"$Nb_bonne_piece";?></span>
								<h5> Nombre de bonnes pièces </h5>
							</div>
						</div>
						<!-- fun_text  -->
